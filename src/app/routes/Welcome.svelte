  ...
  <ViewContent>
    <Card cardId="info">
      ...
      <CardContent>
        ...
        <img width="48" height="48" src={logo} alt="Svelte Logo" class="inline-block" />
        <h2 class="text-4xl uppercase font-thin leading-tight my-8 mx-auto max-w-xs sm:max-w-xs">Microsoft To Do</h2>
        <Button
